...
- **No synthetic data.** The quantum layer consumes only the real rPPG feature table `output/rppg/dataset_features.csv` (421 rows @native 30 fps: 215 real / 206 fake — DFDC archive only; FF++ is NOT used despite README claims). Never reintroduce a generator or a transform/bridge layer.
