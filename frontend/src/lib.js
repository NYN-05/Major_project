...
export const PIPELINE = [
  ...
  { title: "Feature analysis", sub: "Measuring 8 physiological features", icon: Gauge },
...
export const GLOSSARY = {
  ...
  qaoa: "Quantum Approximate Optimization Algorithm — used on this pipeline to select the 6 most informative features from the 8 extracted ones.",
  ...
  mad: "Mean absolute deviation of the pulse waveform using the derivative magnitude approach.",
